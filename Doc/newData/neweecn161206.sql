...
--
-- Host: localhost
-- Generation Time: 2016-12-06 01:07:11
-- 服务器版本： 5.7.11-log
-- PHP Version: 5.6.22
...
(41, 'cs', '测试数据', 0, 0, 10, '', '', '', '', '', '', '', '', '', '1', 0, 1, 1, 0, 0, '', NULL, 1480686488, 1480686488, 1, 1, ''),
(42, 'w_1', '文章1', 41, 0, 10, '', '', '', '', '', '', '', '2', '2', '2', 0, 1, 1, 0, 0, '', NULL, 1480686542, 1480686542, 1, 1, '');
...
CREATE TABLE IF NOT EXISTS `eecn_document` (
  ...
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '数据状态',
  `cover_alt` varchar(255) NOT NULL COMMENT '封面图片描述'
...
(2, 1, '', ' 第一遍测试文章', 42, 0, '测试文章', 0, 0, 2, 2, 4, 0, 0, 1, 0, 0, 0, 0, 0, 0, 1480686664, 1480686664, 3, ''),
(3, 1, '', ' 第一遍测试文章', 42, 0, '测试文章', 0, 0, 2, 2, 4, 0, 1, 1, 0, 0, 0, 0, 0, 0, 1480686600, 1480686709, 1, '');
...
(1, 'admin', 0, '0000-00-00', '', 30, 8, 0, 1479875319, 2130706433, 1480956419, 1);
...
(1, 'admin', '75231e09f275f4d6dc9df2126ef3873c', 'admin@163.com', '', 1479875319, 2130706433, 1480956419, 2130706433, 1479875319, 1);
...
--
-- Indexes for table `eecn_action`
--
ALTER TABLE `eecn_action`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_action_log`
--
ALTER TABLE `eecn_action_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eecn_addons`
--
ALTER TABLE `eecn_addons`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_attachment`
--
ALTER TABLE `eecn_attachment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_record_status` (`record_id`,`status`);

--
-- Indexes for table `eecn_attribute`
--
ALTER TABLE `eecn_attribute`
  ADD PRIMARY KEY (`id`),
  ADD KEY `model_id` (`model_id`);

--
-- Indexes for table `eecn_auth_extend`
--
ALTER TABLE `eecn_auth_extend`
  ADD UNIQUE KEY `group_extend_type` (`group_id`,`extend_id`,`type`),
  ADD KEY `uid` (`group_id`),
  ADD KEY `group_id` (`extend_id`);

--
-- Indexes for table `eecn_auth_group`
--
ALTER TABLE `eecn_auth_group`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_auth_group_access`
--
ALTER TABLE `eecn_auth_group_access`
  ADD UNIQUE KEY `uid_group_id` (`uid`,`group_id`),
  ADD KEY `uid` (`uid`),
  ADD KEY `group_id` (`group_id`);

--
-- Indexes for table `eecn_auth_rule`
--
ALTER TABLE `eecn_auth_rule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `module` (`module`,`status`,`type`);

--
-- Indexes for table `eecn_category`
--
ALTER TABLE `eecn_category`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_name` (`name`),
  ADD KEY `pid` (`pid`);

--
-- Indexes for table `eecn_channel`
--
ALTER TABLE `eecn_channel`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`);

--
-- Indexes for table `eecn_config`
--
ALTER TABLE `eecn_config`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_name` (`name`),
  ADD KEY `type` (`type`),
  ADD KEY `group` (`group`);
...
--
-- Indexes for table `eecn_document`
--
ALTER TABLE `eecn_document`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_category_status` (`category_id`,`status`),
  ADD KEY `idx_status_type_pid` (`status`,`uid`,`pid`);

--
-- Indexes for table `eecn_document_article`
--
ALTER TABLE `eecn_document_article`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_document_download`
--
ALTER TABLE `eecn_document_download`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_file`
--
ALTER TABLE `eecn_file`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_md5` (`md5`);

--
-- Indexes for table `eecn_hooks`
--
ALTER TABLE `eecn_hooks`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);

--
-- Indexes for table `eecn_member`
--
ALTER TABLE `eecn_member`
  ADD PRIMARY KEY (`uid`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `eecn_menu`
--
ALTER TABLE `eecn_menu`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `eecn_model`
--
ALTER TABLE `eecn_model`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_picture`
--
ALTER TABLE `eecn_picture`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_ucenter_admin`
--
ALTER TABLE `eecn_ucenter_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_ucenter_app`
--
ALTER TABLE `eecn_ucenter_app`
  ADD PRIMARY KEY (`id`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `eecn_ucenter_member`
--
ALTER TABLE `eecn_ucenter_member`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `eecn_ucenter_setting`
--
ALTER TABLE `eecn_ucenter_setting`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `eecn_url`
--
ALTER TABLE `eecn_url`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_url` (`url`);

--
-- Indexes for table `eecn_userdata`
--
ALTER TABLE `eecn_userdata`
