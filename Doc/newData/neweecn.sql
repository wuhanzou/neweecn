...
(6, 0, '随笔', 'Cate/index', 6, 1480582494, 1480582494, 1, 0);
...
INSERT INTO `eecn_document` (`id`, `uid`, `name`, `title`, `category_id`, `group_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`) VALUES
...
(1, 'admin', 0, '0000-00-00', '', 20, 3, 0, 1479875319, 2130706433, 1480563389, 1);
...
(1, 'admin', '75231e09f275f4d6dc9df2126ef3873c', 'admin@163.com', '', 1479875319, 2130706433, 1480563389, 2130706433, 1479875319, 1);
